  ...
  "Latest News": [
    {
      ...
      excerpt: 'The "Growing With You" campaign, highlighting the importance of family and connection, earned Silver and Bronze recognitions across two categories.',
    ...
    },
    {
      ...
      headline: "NUTROFREEZE EXPANDS TO 500+ STORES ACROSS CANADA",
      excerpt: "We're thrilled to announce our products are now available at 500+ retail locations coast to coast, including new Costco and Walmart partnerships.",
  ...
  "Company Updates": [
    {
      ...
      headline: "A NEW CHAPTER FOR OUR FAMILY BRAND",
      excerpt: "From our kitchen in Mississauga to kitchens across Canada — we're sharing our new sustainability roadmap and our commitment to community.",
    ...
    },
    {
      ...
      headline: "CERTIFIED B-CORP: OUR COMMITMENT TO DOING GOOD",
      excerpt: "We've achieved B-Corp certification — a testament to our values of people, planet, and authentic food made the right way.",
      img: "https://images.unsplash.com/photo-1649011401502-8b6125f33c3b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmb29kJTIwcHJvZHVjdCUyMGxhdW5jaCUyMGFubm91bmNlbWVudCUyMG5ld3N8ZW58MXx8fHwxNzcyNDk3MTg1fDA&ixlib=rb-4.1.0&q=80&w=800",
      tag: "Milestone",
      tagBg: "#7c3aed",
    },
  ...
  "Product News": [
    {
      ...
      headline: "INTRODUCING KETO ALOO TIKKI — GUILT-FREE CRUNCH",
      excerpt: "Our newest product is finally here! Keto-friendly Aloo Tikki with half the carbs and all the bold flavour you love from the original.",
    ...
    },
    {
      ...
      headline: "PARTY PLATTER PACKS NOW AVAILABLE YEAR-ROUND",
      excerpt: "By popular demand, our fan-favourite Party Platter Packs are now a permanent fixture in our lineup — stocked all year long.",
