...
const REVIEW_HERO_SLIDES: ReviewHero[] = [
  {
    ...
    tag: 'FEATURED REVIEW',
    title: 'NUTROFREEZE\nPURE NUTRITION',
    desc: 'NutroFreeze freeze-dried foods preserve 97% of nutrients and vitamins. Real food, no additives, no preservatives. Loved by families across Singapore.',
    img1: 'https://images.unsplash.com/photo-1576777647084-cac2dd176310?w=480&q=90',
    img2: 'https://images.unsplash.com/photo-1711205229065-89353695a869?w=200&q=80',
  },
  {
    id: 2,
    tag: 'FEATURED REVIEW',
    title: '4.9 STARS\nOUR CUSTOMERS SPEAK',
    desc: 'Families across Singapore rate NutroFreeze as their go-to freeze-dried nutrition brand. Here is what they love most about us.',
  ...
  },
  {
    ...
    tag: 'FEATURED REVIEW',
    title: 'SINGAPORE\nHEALTH AWARDS',
    desc: 'NutroFreeze recognised for bringing pure, wholesome freeze-dried nutrition to families in Singapore. Real food, real convenience, zero tummy stress.',
...
const REVIEW_CARDS: ReviewCard[] = [
  {
    ...
    color: '#0891b2',
    img: 'https://images.unsplash.com/photo-1576777647084-cac2dd176310?w=400&q=80',
    title: '5 STARS FROM HEALTH INSIDER SINGAPORE',
    desc: 'Health Insider Singapore names NutroFreeze the best freeze-dried nutrition brand for 2025, praising its purity and no-additive commitment.',
  },
  {
    id: 2,
    ...
    desc: 'I used to spend hours prepping food. NutroFreeze changed everything. Just add water and you have a wholesome meal in minutes.',
  },
  {
    id: 3,
    tab: 'Press Reviews',
    ...
    title: 'FEATURED IN MOTHERSHIP SINGAPORE',
    desc: 'Mothership spotlights NutroFreeze as a homegrown brand bringing pure, wholesome freeze-dried nutrition to Singapore families.',
  },
  {
    id: 4,
    tab: 'Press Reviews',
    ...
    desc: 'NutroFreeze freeze-dried baby food earns Health Digest top pick for best ready-to-eat nutritious food for infants and toddlers.',
  },
  {
    id: 5,
    tab: 'Customer Reviews',
    ...
    desc: 'The freeze-dried fruit snacks have become a weekly staple in our house. Kids love the crunch and I love that there are zero additives.',
  },
  {
    id: 6,
    tab: 'Customer Reviews',
    ...
    desc: 'NutroFreeze freeze-dried berry blends are my go-to for smoothie bowls. Rich, vibrant and completely natural with no added sugar.',
  },
  {
    id: 7,
    tab: 'Press Reviews',
    color: '#0891b2',
    img: 'https://images.unsplash.com/photo-1662611284583-f34180194370?w=400&q=80',
    title: 'BEST BABY FOOD IN SINGAPORE 2025',
    desc: 'NutroFreeze baby food range recognised for its purity, nutritional value and convenience. No salt, no preservatives, just real ingredients.',
  },
  {
    id: 8,
    tab: 'Customer Reviews',
    ...
    desc: 'We tried the ready-to-eat meals as a family. Flavourful, filling and ready in minutes. We have not looked back since.',
  },
];
